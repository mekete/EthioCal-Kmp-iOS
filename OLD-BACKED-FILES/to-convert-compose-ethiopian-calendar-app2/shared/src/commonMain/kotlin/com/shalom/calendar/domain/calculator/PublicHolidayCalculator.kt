...
/**
 * Calculator for Ethiopian public/national holidays.
 * KMP-compatible version using constructor injection.
 */
class PublicHolidayCalculator(
    ...
    fun getPublicHolidaysForYear(ethiopianYear: Int): List<Holiday> {
        return listOf(
            Holiday(
                ...
                title = resourceProvider.getString("holiday_public_enkutatash"),
                nameAmharic = "እንቁጣጣሽ",
                type = HolidayType.NATIONAL_DAY_OFF,
                ethiopianMonth = 1,
                ethiopianDay = 1,
                isDayOff = true,
                isFixedDate = true,
            ...
            Holiday(
                ...
                title = resourceProvider.getString("holiday_public_adwa"),
                nameAmharic = "የዓድዋ ድል",
                type = HolidayType.NATIONAL_DAY_OFF,
                ethiopianMonth = 6,
                ethiopianDay = 23,
            ...
            Holiday(
                ...
                title = resourceProvider.getString("holiday_public_labour_day"),
            ...
            Holiday(
                ...
                title = resourceProvider.getString("holiday_public_patriots_day"),
