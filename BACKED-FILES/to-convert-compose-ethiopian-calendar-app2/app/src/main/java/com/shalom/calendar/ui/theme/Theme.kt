...
// Blue Color Schemes
private val BlueLightColorScheme = lightColorScheme(primary = blue_light_primary,
...
private val BlueDarkColorScheme = darkColorScheme(primary = blue_dark_primary,
...
// Red Color Schemes
private val RedLightColorScheme = lightColorScheme(primary = red_light_primary,
...
private val RedDarkColorScheme = darkColorScheme(primary = red_dark_primary,
...
// Green Color Schemes
private val GreenLightColorScheme = lightColorScheme(primary = green_light_primary,
...
private val GreenDarkColorScheme = darkColorScheme(primary = green_dark_primary,
...
private val PurpleLightColorScheme = lightColorScheme(primary = purple_light_primary,
...
private val PurpleDarkColorScheme = darkColorScheme(primary = purple_dark_primary,
...
private val OrangeLightColorScheme = lightColorScheme(primary = orange_light_primary,
...
private val OrangeDarkColorScheme = darkColorScheme(primary = orange_dark_primary,
...
fun EthiopianCalendarTheme(
    appTheme: AppTheme = AppTheme.BLUE, themeMode: ThemeMode = ThemeMode.SYSTEM, content: @Composable () -> Unit
) {
    ...
    // Edge-to-edge handling is now managed by enableEdgeToEdge() in MainActivity
    // No need for manual window insets configuration here
