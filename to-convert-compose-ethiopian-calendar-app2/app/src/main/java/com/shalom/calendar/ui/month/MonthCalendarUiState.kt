...
sealed class MonthCalendarUiState {
    ...
    data class Success(
        val currentMonth: EthiopicDate, val dateList: List<EthiopicDate>, val calendarItems: List<HolidayOccurrence>, val events: List<EventInstance>, val selectedDate: EthiopicDate?, val primaryCalendar: CalendarType, val displayDualCalendar: Boolean, val secondaryCalendar: CalendarType, val currentGregorianYear: Int?, val currentGregorianMonth: Int?
